...
class BEVHead(BaseModule):
    def __init__(self,
        ...
        self.transformer: PerceptionTransformerBEVEncoder = build_transformer(
            transformer)
    ...
    def forward(self, mlvl_feats, img_metas, prev_bev=None, only_bev=False):
        ...
        bev_feature = bev_embed.permute(0, 2, 1).reshape(
    ...
    def loss(self,
        ...
        return self.pts_bbox_head_3d.loss(
            gt_bboxes_list, gt_labels_list, ret['pred'], gt_bboxes_ignore=gt_bboxes_ignore, img_metas=img_metas)
...
class FreeAnchor3DHeadV2(FreeAnchor3DHead):
    ...
    def loss(self,
        ...
        return super().loss(cls_scores, bbox_preds, dir_cls_preds,
                            gt_bboxes_list, gt_labels_list, img_metas, gt_bboxes_ignore)
