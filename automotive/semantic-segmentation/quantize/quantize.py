...
def main():
    ...
    parser.add_argument("model_prep_path", type=str, help="Path to the prepped ONNX model.")
    parser.add_argument("model_quant", type=str, help="Path to save the quantized ONNX model.")
    parser.add_argument("--data-root", type=str, help="path to calibration files")
    ...
    quantization.shape_inference.quant_pre_process(args.model_fp32, args.model_prep_path)
    quantized_model = quantization.quantize_static(args.model_prep_path, args.model_quant, cal_reader)
