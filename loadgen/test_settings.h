...
struct TestSettings {
  ...
  /// \brief If this flag is set to true, LoadGen the time between samples
  /// genera- ted by LoadGen in the server scenario is set to constant.
  /// Otherwise, the time between samples follows an exponential distribution
